exports.id=383,exports.ids=[383],exports.modules={5488:(e,t,i)=>{Promise.resolve().then(i.t.bind(i,9404,23)),Promise.resolve().then(i.bind(i,692))},9987:(e,t,i)=>{"use strict";i.d(t,{EE:()=>n,bd:()=>o,nd:()=>a,zQ:()=>r});let a=[{slug:"electronic-grade-ipa-semiconductor-wafer-cleaning",title:"Electronic Grade IPA for Semiconductor Wafer Cleaning: G2 to G5 Specification Guide",metaTitle:"Electronic Grade IPA Wafer Cleaning Guide | SEMI G2–G5 Specifications | PureTech",metaDescription:"Complete guide to electronic grade isopropyl alcohol (IPA) for semiconductor wafer cleaning. Understand SEMI G2, G3, G4, G5 purity grades, ICP-MS metal limits, LPC particle specs, and Marangoni drying applications.",category:"Electronic Grade Solvents",tags:["electronic grade IPA","SEMI C1","wafer cleaning","Marangoni drying","ICP-MS","LPC","CMP post-clean","isopropyl alcohol semiconductor"],date:"2025-03-15",readTime:12,image:"/blog-images/electronic-grade-ipa-wafer-cleaning-semi-g5-specification.svg",imageAlt:"Electronic grade IPA SEMI G2 G3 G4 G5 purity specification chart showing assay water metals and particle limits for semiconductor wafer cleaning",seoKeywords:["buy electronic grade IPA semiconductor","SEMI C1 Tier D G5 IPA supplier","ultra pure isopropyl alcohol 99.9999%","IPA for CMP post clean","Marangoni drying IPA G5","electronic grade IPA bulk supply 200L IBC","IPA lot CoA ICP-MS certificate","semiconductor rinse solvent IPA specification","isopropyl alcohol wafer clean SEMI C1","LPC particle count IPA G5","IPA G4 G5 price supplier China","where to buy electronic grade IPA","IPA semiconductor fab supply qualification"],excerpt:"Electronic grade IPA (isopropyl alcohol) is the single highest-volume wet chemical consumed in semiconductor manufacturing. This guide explains SEMI G2 through G5 purity tiers, critical specification parameters, and how to select the correct grade for each fab process step.",content:`
...
<p>Selecting the correct electronic grade IPA tier directly impacts fab yield. G4 grade provides the right balance of purity and cost-effectiveness for most 14nm+ applications; G5 (6N purity) is essential for sub-7nm nodes, EUV processes, and Marangoni drying. Always specify ICP-MS and LPC certification with each lot, and verify that your supplier's fill environment meets ISO Class 3 requirements.</p>
    `},{slug:"pgmea-photoresist-solvent-euv-arf-lithography",title:"PGMEA as a Photoresist Solvent: Applications in ArF Immersion and EUV Lithography",metaTitle:"PGMEA Photoresist Solvent for EUV & ArF Immersion Lithography | PureTech",metaDescription:"Learn how PGMEA (propylene glycol monomethyl ether acetate) functions as the primary photoresist solvent in ArF immersion, EUV CAR, and metal oxide resist formulations. Specification guide for G4 and G5 grade PGMEA.",category:"Photoresist & Lithography",tags:["PGMEA","photoresist solvent","EUV lithography","ArF immersion","chemically amplified resist","CAR","spin coating","edge bead removal","SEMI C12"],date:"2025-03-28",readTime:10,image:"/blog-images/pgmea-photoresist-solvent-euv-arf-immersion-lithography-specification.svg",imageAlt:"PGMEA photoresist solvent EUV ArF immersion lithography stack diagram showing CAR resist formulation EBR process and SEMI C12 specification",seoKeywords:["PGMEA supplier semiconductor grade","buy PGMEA EUV lithography","PGMEA G4 G5 purity specification","PGMEA vs PGME photoresist solvent","SEMI C12 PGMEA specification","PGMEA MPA 1-methoxy-2-propyl acetate","PGMEA ArF immersion resist","PGMEA EBR edge bead removal","PGMEA total metals ICP-MS ppb","photoresist solvent supplier","PGMEA bulk IBC supply","PGMEA CoA lot analysis"],excerpt:"PGMEA is the dominant primary solvent in advanced photoresist formulations for ArF immersion and EUV lithography. This article covers its physicochemical properties, why it outperforms alternatives, and the critical purity specifications required for leading-edge nodes.",content:`
...
<ul>
  ...
  <li><strong>Moderate boiling point (146\xb0C):</strong> Enables controlled evaporation during spin coating, producing uniform films from 20nm to 10μm thickness.</li>
...
<p>PGMEA's unique combination of polymer solvency, boiling point, and compatibility with photolithography chemistries has sustained its position as the primary photoresist solvent from 248nm through EUV. As EUV and high-NA EUV become high-volume manufacturing nodes, G5 grade PGMEA with sub-0.1 ppb metal control becomes the baseline specification for resist formulation solvents.</p>
    `},{slug:"nmp-battery-electrode-slurry-pvdf-binder",title:"NMP in Lithium Battery Electrode Slurry: PVDF Binder Dissolution and Cathode Coating",metaTitle:"NMP Battery Electrode Slurry PVDF Binder | Electronic Grade NMP | PureTech",metaDescription:"NMP (N-methyl-2-pyrrolidone) is the essential solvent for PVDF binder dissolution in NMC and LFP cathode slurry for lithium-ion batteries. Learn G4/G5 grade requirements, water limits, and metal contamination specs for EV battery manufacturing.",category:"Battery & Energy Storage",tags:["NMP battery","PVDF binder","cathode slurry","NMC electrode","LFP battery","lithium-ion battery manufacturing","electrode coating","N-methyl-2-pyrrolidone","EV battery chemicals"],date:"2025-04-05",readTime:11,image:"/blog-images/nmp-battery-electrode-slurry-pvdf-binder-lithium-ion.svg",imageAlt:"NMP N-methyl-2-pyrrolidone battery electrode slurry process diagram PVDF binder dissolution NMC LFP cathode coating steps",seoKeywords:["NMP for lithium battery electrode","buy battery grade NMP","NMP PVDF binder dissolution","NMP G4 G5 battery electrolyte","NMP cathode slurry NMC LFP","NMP EV battery supply","NMP Fe Ni ppb ICP-MS specification","NMP water content KF battery","NMP IBC bulk supply EV gigafactory","NMP NCA cathode slurry","NMP supplier China battery","NMP price ton battery grade"],excerpt:"N-methyl-2-pyrrolidone (NMP) is indispensable for lithium-ion battery electrode manufacturing. This technical article explains why NMP is the only practical solvent for PVDF binder dissolution, its role in NMC and LFP cathode slurry preparation, and the electronic grade purity requirements for EV gigafactory applications.",content:`
...
<ol>
  <li><strong>PVDF dissolution:</strong> PVDF powder is dissolved in anhydrous NMP (≤50 ppm H₂O) at 60–80\xb0C with high-shear mixing for 4–8 hours to form a homogeneous binder solution.</li>
  ...
  <li><strong>Viscosity adjustment:</strong> Additional NMP is added to achieve target slurry viscosity (typically 3,000–8,000 mPa\xb7s at 25\xb0C) for blade coating on the current collector.</li>
  <li><strong>Coating and drying:</strong> The slurry is coated onto aluminum foil at 0.5–2.0 m/min, then dried in a series of heated zones at 80–120\xb0C to evaporate NMP. Recovered NMP is purified and recycled.</li>
</ol>
...
<p>NMP's unique solvency for PVDF binder makes it irreplaceable in lithium-ion battery electrode manufacturing at current technology readiness levels. Electronic grade G4 NMP — with ≤0.5 ppb total metals, ≤50 ppm water, and APHA color ≤10 — is the baseline specification for EV-grade cell production. For high-cycle-life premium cells, G5 grade with &lt;0.05 ppb Fe/Ni is increasingly specified by leading cell manufacturers.</p>
    `},{slug:"dmc-lithium-battery-electrolyte-solvent",title:"Dimethyl Carbonate (DMC) in Lithium-Ion Battery Electrolytes: Properties, Grades, and EV Applications",metaTitle:"DMC Lithium Battery Electrolyte Solvent | Electronic Grade DMC | PureTech",metaDescription:"Dimethyl carbonate (DMC) is a critical co-solvent in LiPF₆-based Li-ion battery electrolytes. Learn about EC/DMC/EMC formulations, G4/G5 grade specifications, water and chloride limits, and DMC's role in NMC, LFP, and solid-state battery systems.",category:"Battery & Energy Storage",tags:["DMC battery electrolyte","dimethyl carbonate","LiPF6 electrolyte","EC DMC EMC","NMC battery","LFP electrolyte","solid state battery","EV battery chemicals","battery grade DMC"],date:"2025-04-18",readTime:10,image:"/blog-images/dmc-lithium-battery-electrolyte-ec-dmc-emc-ev-battery.svg",imageAlt:"DMC dimethyl carbonate EC DMC EMC lithium ion battery electrolyte composition diagram LiPF6 co-solvent system for NMC LFP EV battery",seoKeywords:["buy battery grade DMC","DMC G5 electrolyte supplier","dimethyl carbonate EV battery","EC DMC EMC electrolyte formulation","DMC water content battery grade","DMC chloride ppb specification","DMC for NMC LFP NCA battery","dimethyl carbonate LiPF6 co-solvent","DMC vs DEC EMC electrolyte","battery grade DMC price","DMC G4 G5 ICP-MS certified","battery electrolyte solvent supplier"],excerpt:"Dimethyl carbonate (DMC) is one of the three primary co-solvents in standard LiPF₆ lithium-ion battery electrolytes. This article covers DMC physicochemical properties, EC/DMC/EMC electrolyte formulation rationale, and the ultra-pure G4/G5 grade specifications required for EV battery manufacturing.",content:`
...
<table>
  ...
  <tbody>
    <tr><td>Boiling point</td><td>90 \xb0C</td><td>Low BP enables easy drying; flash point safety consideration</td></tr>
    <tr><td>Viscosity (25\xb0C)</td><td>0.59 mPa\xb7s</td><td>Lowest viscosity of common carbonate solvents — improves Li⁺ conductivity</td></tr>
    <tr><td>Dielectric constant</td><td>3.1</td><td>Low ε; must be blended with high-ε solvents (EC) for Li⁺ dissociation</td></tr>
    <tr><td>Melting point</td><td>4.6 \xb0C</td><td>Liquid at room temperature; extends low-temperature operation</td></tr>
    <tr><td>Electrochemical window</td><td>&gt;5.0 V vs. Li/Li⁺</td><td>Stable with high-voltage NMC cathodes (≤4.35 V)</td></tr>
    <tr><td>Density (25\xb0C)</td><td>1.069 g/mL</td><td>Relevant for electrolyte formulation by weight/volume</td></tr>
  </tbody>
</table>
...
<ul>
  ...
  <li><strong>DMC:</strong> Low viscosity reduces solution resistance and improves ion mobility. High electrochemical oxidation stability enables NMC cathode compatibility. Co-solvent that reduces the high melting point and viscosity of pure EC (melts at 36\xb0C).</li>
...
<p>HF attacks the cathode surface, dissolves transition metals (Mn, Ni, Co), and degrades the SEI layer on the anode. G5 grade DMC (≤10 ppm H₂O) is specified for premium cell electrolyte formulations. Even G4 (≤20 ppm H₂O) requires careful handling in dry rooms (dew point ≤ -40\xb0C) to prevent moisture uptake before electrolyte mixing.</p>
...
<p>Electronic grade DMC is a critical material in the lithium-ion battery supply chain. G4 grade (≤20 ppm H₂O, ≤0.5 ppb total metals, ≤100 ppb Cl⁻) serves most EV battery production applications. G5 grade with sub-0.1 ppb metal control and ≤10 ppm water is specified for high-cycle-life premium cells and solid-state battery research.</p>
    `},{slug:"hplc-grade-acetonitrile-pharmaceutical-lc-ms",title:"HPLC Grade Acetonitrile for Pharmaceutical LC-MS Analysis: Specification and Selection Guide",metaTitle:"HPLC Grade Acetonitrile LC-MS Pharmaceutical Analysis | PureTech",metaDescription:"Complete guide to selecting HPLC, HPLC gradient, and LC-MS grade acetonitrile for pharmaceutical analysis. Covers UV absorbance cutoffs, water limits, acrylonitrile impurity, and differences between HPLC-P, HPLC-G, and LC-MS grades.",category:"Laboratory & Analytical",tags:["HPLC acetonitrile","LC-MS grade","acetonitrile pharmaceutical","HPLC mobile phase","UV absorbance cutoff","gradient grade acetonitrile","LC-MS/MS analysis","acetonitrile specification"],date:"2025-05-02",readTime:9,image:"/blog-images/hplc-grade-acetonitrile-lc-ms-pharmaceutical-analysis-uv-absorbance.svg",imageAlt:"HPLC grade acetonitrile LC-MS pharmaceutical analysis chromatogram UV absorbance limits for gradient HPLC-G and LC-MS grades compared",seoKeywords:["buy HPLC grade acetonitrile","LC-MS grade acetonitrile supplier","acetonitrile UV absorbance 254nm specification","HPLC gradient acetonitrile pharmaceutical","LC-MS mobile phase MeCN","acetonitrile lot CoA UV cutoff","acetonitrile acrylonitrile impurity","HPLC acetonitrile vs methanol","buy acetonitrile 200L drum","LC-MS acetonitrile low background","pharmaceutical grade acetonitrile USP","acetonitrile UHPLC sub-2-micron"],excerpt:"Acetonitrile (ACN, MeCN) is the most widely used HPLC and LC-MS mobile phase solvent in pharmaceutical analysis. This guide covers how to choose between HPLC preparation, HPLC gradient, and LC-MS grades based on your analytical application, detector type, and required detection limits.",content:`
...
<p>Matching acetonitrile grade to your analytical application avoids both performance failures and unnecessary cost. LC-MS grade is the correct specification for any method involving mass detection, ESI, or APCI. HPLC gradient grade serves most UV-based gradient methods. For truly critical applications — low-level impurity profiling by LC-MS/MS or method validation — always qualify the specific lot of acetonitrile as part of system suitability.</p>
    `},{slug:"advanced-packaging-solvents-fowlp-hbm-2.5d",title:"Wet Process Chemicals for Advanced Packaging: FOWLP, HBM, 2.5D Interposer, and 3D-IC",metaTitle:"Solvents for Advanced Packaging FOWLP HBM 2.5D 3D-IC | PureTech",metaDescription:"Technical guide to wet process chemicals for advanced semiconductor packaging including FOWLP, HBM, 2.5D silicon interposer, and 3D-IC. Covers PGMEA for RDL lithography, NMP for polyimide, and IPA for substrate cleaning.",category:"Advanced Packaging",tags:["advanced packaging chemicals","FOWLP solvent","HBM packaging","2.5D interposer","3D-IC packaging","RDL lithography","polyimide solvent","chip-on-wafer","advanced packaging IPA","heterogeneous integration"],date:"2025-05-15",readTime:11,image:"/blog-images/advanced-packaging-fowlp-hbm-2.5d-interposer-wet-chemicals.svg",imageAlt:"Advanced packaging 2.5D HBM CoWoS cross-section showing PGMEA NMP IPA solvent applications for RDL lithography polyimide coating and substrate cleaning",seoKeywords:["advanced packaging wet chemicals","FOWLP solvents supply","HBM packaging chemistry","2.5D silicon interposer wet process","RDL lithography PGMEA supplier","PI polyimide NMP advanced packaging","3D-IC cleaning solvents","FOWLP substrate cleaning IPA G4","heterogeneous integration chemicals","advanced packaging solvent supplier","PGMEA NMP OSAT packaging","advanced packaging chemical qualification"],excerpt:"Advanced packaging — FOWLP, CoW, HBM, 2.5D interposer, and 3D-IC — has become a primary technology driver as device scaling slows. This article maps the critical wet process chemicals (PGMEA, PGME, NMP, IPA, acetone) to specific advanced packaging process steps and their purity requirements.",content:`
...
<p>After deep reactive ion etching (DRIE) of TSV holes (diameter 5–10 μm, depth 50–100 μm), photoresist residues and etch by-products must be removed without damaging the high-aspect-ratio silicon structures. NMP G4 at elevated temperature (80\xb0C) is used for positive thick photoresist stripping. G4 IPA rinse (≤10 ct/mL at ≥0.5 μm) prevents particle redeposition in the high-aspect-ratio vias.</p>
...
<p>Advanced packaging processes require a tailored solvent portfolio: G4/G5 PGMEA for RDL lithography, G4/G5 NMP for PI precursor and resist stripping, and G4 IPA for substrate cleaning and post-process rinse. As heterogeneous integration scales to sub-2μm RDL and drives toward 3D stacking of memory and logic, solvent purity requirements will continue to tighten toward G5 specifications across all process steps.</p>
    `},{slug:"marangoni-drying-ipa-watermark-free-wafer",title:"Marangoni Drying with IPA: Achieving Watermark-Free Wafer Drying at Sub-5nm Nodes",metaTitle:"Marangoni Drying IPA Watermark-Free Wafer | Semiconductor Drying Technology | PureTech",metaDescription:"Marangoni drying uses IPA vapor to create a surface tension gradient that dries wafers without watermarks or stiction. Learn the physics, IPA purity requirements (G5 grade), and process parameters for sub-5nm node applications.",category:"Semiconductor Process",tags:["Marangoni drying","IPA vapor drying","watermark-free drying","wafer drying","stiction","MEMS drying","semiconductor drying","IPA G5","surface tension gradient","spin-dry alternative"],date:"2025-06-01",readTime:9,image:"/blog-images/marangoni-drying-ipa-vapor-watermark-free-semiconductor-wafer.svg",imageAlt:"Marangoni drying IPA vapor mechanism diagram surface tension gradient slow-pull watermark-free stiction-free wafer drying G5 specification",seoKeywords:["Marangoni drying IPA G5 specification","watermark-free wafer drying IPA","IPA vapor Marangoni effect mechanism","stiction-free drying MEMS IPA","Marangoni dryer IPA purity requirement","G5 IPA Marangoni water limit 5ppm","post-CMP Marangoni drying IPA","Marangoni drying sub-7nm node","IPA G5 Marangoni particle count","watermark defect IPA purity solution","IPA Marangoni vs supercritical CO2"],excerpt:"Marangoni drying replaces conventional spin-dry to eliminate watermarks and stiction at advanced nodes. This article explains the Marangoni effect physics, why G5 IPA purity (≤5 ppm water) is essential, and how Marangoni drying is implemented in CMP post-clean and MEMS fabrication.",content:`
...
<p>The Marangoni effect describes fluid motion driven by surface tension gradients. Water has a surface tension of ~72 mN/m at 25\xb0C; IPA has a surface tension of ~22 mN/m. When IPA vapor is introduced above a wet wafer surface, IPA dissolves preferentially at the water surface, creating a localized region of reduced surface tension.</p>
...
<p>Metal ions in IPA are carried to the wafer surface by the Marangoni-driven water film. Even at 0.1 ppb, iron (Fe) and sodium (Na) can create metal contamination exceeding fab limits after deposition. G5 IPA (total metals &lt;0.1 ppb each) ensures metal deposition below TXRF detection limits (&lt;10⁹ atoms/cm\xb2).</p>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Particle performance</td><td>&lt;5 particles/cm\xb2 (&gt;0.2μm)</td><td>&lt;1 particle/cm\xb2</td></tr>
  </tbody>
</table>
...
<p>Marangoni drying with G5 electronic grade IPA is the industry-standard method for watermark-free, stiction-free wafer drying at sub-7nm nodes and in MEMS fabrication. The G5 specification (≤5 ppm H₂O, &lt;0.1 ppb total metals, ≤1 ppm acetone) is not over-specified — each parameter directly impacts Marangoni flow stability, particle redeposition, and metal contamination at the wafer surface.</p>
    `},{slug:"semi-c1-standard-electronic-chemicals-semiconductor",title:"Understanding the SEMI C1 Standard for Electronic Grade Chemicals in Semiconductor Manufacturing",metaTitle:"SEMI C1 Standard Electronic Grade Chemicals Explained | PureTech",metaDescription:"Comprehensive guide to the SEMI C1 standard for electronic grade chemicals. Explains Tier A (G2) through Tier D (G5) grade definitions, ICP-MS and LPC test methods, and how to specify SEMI C1 compliant chemicals for semiconductor manufacturing.",category:"Standards & Compliance",tags:["SEMI C1","electronic grade chemicals","SEMI standard","semiconductor chemicals standard","ICP-MS semiconductor","liquid particle counting","Grade G2 G3 G4 G5","chemical specification semiconductor","SEMI C12"],date:"2025-06-18",readTime:10,image:"/blog-images/semi-c1-standard-electronic-grade-chemicals-g2-g3-g4-g5-tiers.svg",imageAlt:"SEMI C1 standard electronic grade chemical tiers G2 G3 G4 G5 purity comparison showing ICP-MS particle count and water requirements per tier",seoKeywords:["SEMI C1 standard explained","SEMI C1 Tier D G5 specification","how to read SEMI C1 CoA","SEMI C12 photoresist chemical spec","SEMI C1 ICP-MS requirements 28 elements","SEMI C1 LPC particle specification","electronic grade chemical SEMI certified supplier","SEMI C1 Tier A B C D difference","SEMI C1 certificate of analysis requirements","electronic grade chemical qualification protocol","SEMI C30 hydrogen peroxide","semiconductor chemical SEMI audit"],excerpt:"The SEMI C1 standard defines purity requirements for electronic grade chemicals used in semiconductor manufacturing. This article explains the four SEMI C1 tiers (G2–G5), required test methods, and how to read and specify SEMI-compliant chemical documentation for your fab procurement process.",content:`
...
<ol>
  ...
  <li>LPC data (actual count \xb1 uncertainty, not just "compliant")</li>
...
<p>SEMI C1 provides a standardized framework for electronic grade chemical specification that enables fabs, OSATs, and chemical suppliers to communicate purity requirements unambiguously. When procuring electronic grade chemicals, always specify the SEMI C1 tier explicitly in the purchase order, require a full CoA with individual element ICP-MS data and in-line LPC per container, and periodically re-qualify your supplier's fill environment against SEMI C1 audit requirements.</p>
    `},{slug:"compound-semiconductor-cleaning-gan-sic-gaas",title:"Wet Chemical Cleaning for Compound Semiconductors: GaN, SiC, InP, and GaAs",metaTitle:"Wet Chemical Cleaning GaN SiC InP GaAs Compound Semiconductor | PureTech",metaDescription:"Guide to wet chemical cleaning for compound semiconductors including GaN power devices, SiC MOSFETs, InP HEMTs, and GaAs solar cells. Covers IPA halide purity requirements, n-heptane degreasing, and ethanol cleaning for LED and VCSEL applications.",category:"Compound Semiconductor",tags:["GaN cleaning","SiC MOSFET process","compound semiconductor cleaning","InP HEMT","GaAs solar cell","VCSEL cleaning","LED substrate cleaning","halide-free IPA","n-heptane semiconductor","compound semiconductor wet process"],date:"2025-07-02",readTime:9,image:"/blog-images/compound-semiconductor-cleaning-gan-sic-inp-gaas-halide-free-ipa.svg",imageAlt:"Compound semiconductor cleaning GaN SiC InP GaAs halide-free IPA requirements showing chloride fluoride ppb limits for each III-V material",seoKeywords:["GaN substrate cleaning IPA halide-free","SiC MOSFET wet clean process","InP HEMT cleaning anhydrous IPA","GaAs solar cell cleaning ethanol","GaN power device wet process chemicals","halide-free IPA compound semiconductor","n-heptane GaN MOCVD reactor cleaning","III-V semiconductor cleaning solvents","compound semiconductor cleaning supplier","GaN cleaning Cl fluoride specification","SiC cleaning post-implant NMP","VCSEL LED cleaning ethanol G3"],excerpt:"Compound semiconductor devices — GaN power devices, SiC MOSFETs, InP HEMTs, and GaAs solar cells — have specific wet cleaning requirements that differ significantly from silicon CMOS. This article covers the critical chemical purity requirements, particularly halide control in IPA and hydrocarbon solvents, for compound semiconductor fabrication.",content:`
...
<p>4H-SiC power MOSFETs require an exceptionally clean SiO₂/SiC interface to achieve acceptable channel electron mobility (target: &gt;50 cm\xb2/V\xb7s vs. &lt;20 cm\xb2/V\xb7s for typical SiC oxide quality). Standard RCA cleaning (SC-1, SC-2, HF dip) is used, with IPA G4 for all final rinse steps after the HF oxide strip.</p>
...
<p>Vertical-cavity surface-emitting lasers (VCSELs) and high-brightness LEDs use GaN, AlGaAs, and InGaP epitaxial structures. Electronic grade ethanol (G3, ≤1 ppb total metals) is the standard cleaning solvent for LED chip surfaces before bond wire attachment and encapsulation. Ethanol's low surface tension and rapid evaporation rate (BP 78\xb0C) make it preferable to IPA for LED die surfaces where residual solvent causes optical absorption.</p>
...
<p>Compound semiconductor wet cleaning requires careful attention to halide impurities (Cl⁻, F⁻) in cleaning solvents — particularly IPA and hydrocarbon solvents. G4 IPA with Cl⁻ ≤0.5 ppb is the baseline specification for GaN and GaAs substrate cleaning. n-Heptane G4 with ≤0.5 ppm benzene and ≤10 ppm total aromatics is specified for GaN MOCVD reactor cleaning. Anhydrous IPA (≤10 ppm H₂O) is required for InP device processes.</p>
    `},{slug:"electronic-grade-acetone-osat-backend-cleaning",title:"Electronic Grade Acetone in Semiconductor OSAT and Back-End-of-Line Cleaning",metaTitle:"Electronic Grade Acetone OSAT Backend Cleaning | Semiconductor Packaging | PureTech",metaDescription:"Electronic grade acetone (G2–G5) is essential for OSAT semiconductor packaging, flux residue removal, die preparation, and wire bonding surface cleaning. Learn grade selection, specifications, and backend packaging process applications.",category:"OSAT & Backend Process",tags:["electronic grade acetone","OSAT cleaning","semiconductor backend","flux removal","wire bonding","die preparation","solder flux acetone","OSAT chemicals","packaging solvent","back-end semiconductor"],date:"2025-07-20",readTime:8,image:"/blog-images/electronic-grade-acetone-osat-backend-semiconductor-packaging-cleaning.svg",imageAlt:"Electronic grade acetone OSAT backend semiconductor packaging process flow die prep wire bonding flux removal BGA cleaning applications",seoKeywords:["electronic grade acetone OSAT cleaning","buy acetone G3 G4 semiconductor packaging","acetone flux residue removal semiconductor","wire bonding surface prep acetone","die preparation cleaning acetone G4","OSAT chemical supplier acetone","acetone residue on evaporation specification","acetone IPA content G4 spec","solder flux cleaning acetone BGA","semiconductor backend cleaning solvent","OSAT packaging chemicals supplier","flip-chip cleaning acetone electronic grade"],excerpt:"Electronic grade acetone is the primary organic cleaning solvent in OSAT (outsourced semiconductor assembly and test) and back-end-of-line (BEOL) processes. This article covers acetone applications in die preparation, flux removal, wire bonding surface prep, and the G2–G5 grade selection criteria for different packaging technologies.",content:`
...
<ul>
  <li><strong>Low boiling point (56.1\xb0C):</strong> Fast evaporation leaves minimal residue; critical for high-throughput packaging lines where drying time is a cycle time bottleneck.</li>
...
<p>Residue on evaporation (gravimetric method, 105\xb0C) is the most critical specification for OSAT acetone. Any non-volatile residue remaining after acetone evaporation deposits directly on the bond pad or substrate surface, potentially causing wire bond failures or adhesion reduction. G4 spec: ≤2 ppm; G5: ≤0.5 ppm.</p>
...
<p>Electronic grade acetone (G2–G4) is indispensable across the OSAT process flow, from die preparation through final cleaning before molding. Grade selection is straightforward: G4 for advanced flip-chip and heterogeneous packaging (sub-10nm die), G3 for wire bonding and flux cleaning, G2 for leadframe degreasing. The most critical specifications for OSAT applications are residue on evaporation (≤2 ppm for G4), IPA content (≤20 ppm), and total metals (≤0.5 ppb for advanced packaging).</p>
    `}];function r(e){return a.find(t=>t.slug===e)}function n(e,t=3){let i=r(e);return i?a.filter(t=>t.slug!==e&&(t.category===i.category||t.tags.some(e=>i.tags.includes(e)))).slice(0,t):[]}let o=[...new Set(a.map(e=>e.category))]}};