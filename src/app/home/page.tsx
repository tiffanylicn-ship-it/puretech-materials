            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2.5 mb-8">
                ...
                <div className="text-[11px] font-mono rounded-full px-3 py-1.5"
                  ...
                  42+ Products · G1–G5 · Full Wet Chemical Portfolio
                </div>
              </div>
      ...
      <section className="py-20 bg-[#F2F6FB]">
        <Container>
          <Reveal className="mb-10">
            ...
            <SectionTitle>SEMI Grade G1 → G5 Full Range</SectionTitle>
            <SectionSub>From entry-level PCB/display cleaning (G1) to sub-7nm EUV (G5) — match the right grade to your process node. Every tier certified by ICP-MS and in-line LPC.</SectionSub>
          </Reveal>
          <Reveal delay={60}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {[
                { g:'G1',pur:'99.0%',    met:'≤50 ppb',  parts:'≤500/mL', node:'PCB / Display / Solar', c:'#1E3A5F', w:'38%' },
                { g:'G2',pur:'99.9%',    met:'≤10 ppb',  parts:'≤100/mL', node:'≥180nm Mature Node',    c:'#003DA5', w:'52%' },
                { g:'G3',pur:'99.99%',   met:'≤2 ppb',   parts:'≤20/mL',  node:'45–180nm',              c:'#0050C8', w:'66%' },
                { g:'G4',pur:'99.999%',  met:'≤0.5 ppb', parts:'≤10/mL',  node:'7–45nm',                c:'#0066CC', w:'80%' },
