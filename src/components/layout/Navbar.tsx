...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    dd:[
      { label:'Semiconductor & IC Fabrication', href:'/industries/semiconductor' },
      { label:'EV Battery & Energy Storage',    href:'/industries/ev-battery' },
      { label:'Display & OLED',                 href:'/industries/display-panel' },
      { label:'Pharmaceutical & HPLC Lab',      href:'/industries/pharmaceutical-lab' },
      { divider:true },
  ...
  },
  {
    ...
    dd:[
      ...
      { label:'PGMEA for EUV Lithography',    href:'/solutions/pgmea-for-euv-lithography' },
      { label:'NMP for Battery Electrode',    href:'/solutions/nmp-for-battery-electrode' },
      { divider:true },
