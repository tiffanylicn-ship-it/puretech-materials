  ...
  return (
    <div className="leading-none select-none">
      <div className="flex items-baseline gap-0">
        <span style={{ fontSize:18, fontWeight:800, letterSpacing:'-0.5px', fontFamily:"'Outfit',sans-serif", color: light ? '#FFFFFF' : '#0A1628' }}>Pure</span>
        <span style={{ fontSize:18, fontWeight:800, letterSpacing:'-0.5px', fontFamily:"'Outfit',sans-serif", color:'#0066CC' }}>Tech</span>
      </div>
      <div style={{ fontSize:9, fontWeight:700, letterSpacing:'0.22em', textTransform:'uppercase', marginTop:2, color: light ? 'rgba(255,255,255,0.42)' : '#506880', fontFamily:"'Outfit',sans-serif" }}>
        Materials
      </div>
    </div>
  )
